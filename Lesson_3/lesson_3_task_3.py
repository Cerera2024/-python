...
to_address = Address('123456', 'Москва', 'ул. Ленина', '10', '5')
from_address = Address('654321', 'Санкт-Петербург', 'пр. Мира', '20', '15')

mailing = Mailing(to_address, from_address, 1000, 'AB123456789')
